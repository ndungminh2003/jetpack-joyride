...
export class GameManager {
    ...
    private createCamera() {
        ...
        this.scene.cameras.main.setBounds(0, 0, Infinity, this.mapGenerator.getMap().heightInPixels)
    }
    ...
    private generateObstacle() {
        const missileX = this.scene.cameras.main.scrollX + this.scene.cameras.main.width - 50
        const missileY = this.player.y + this.player.body.height / 4
        let obstacle = new Missile(this.scene, missileX, missileY, this.player.body.velocity.x)
